...
// change user input for title to all lower case, then add to h1
...
// select random name from array on button click
function selectRan(){
...
// hide #picked (results) div on mouse click outside of div
